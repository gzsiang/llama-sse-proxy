...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # Dashboard endpoint - serve HTML from external file
        ...
        if path in ("/stats", "/zh", "/en", "/", "/stats.html", "/dashboard") or path.startswith("/stats/"):
            with STATS_LOCK:
            ...
            # Read dashboard.html from the same directory as this script
            ...
            try:
                ...
                html = "<!DOCTYPE html><html><body><h1>Dashboard not found</h1><p>Please ensure dashboard.html exists.</p></body></html>"
